            ...
            {isLogin ? (
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-full py-3 cursor-pointer bg-linear-to-r from-purple-600 via-purple-700 to-purple-800 text-white font-semibold rounded-lg relative overflow-hidden group"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <motion.div
